  ...
  users,
    ...
    headersMenus: [
        ...
        },
        {
            ...
            href: "/search?category=beauty-personal-care"
        },
        {
            name: "Home & Kitchen",
        ...
        {
            name: "Toys & Games",
            href: "/search?category=toys-games"
        },
        {
            name: "Automotive",
    ...
    carousels: [
        {
            title: "Trending T-Shirts Collection",
            buttonCaption: "Shop Now",
            image: "/images/banner1.jpg",
            url: "/search?categories=t-shirts",
            isPublished: true
        },
        {
            title: "Exclusive Watches on Sale",
            buttonCaption: "Explore Now",
            image: "/images/banner2.jpg",
            url: "/search?categories=watches",
            isPublished: true
        },
        {
